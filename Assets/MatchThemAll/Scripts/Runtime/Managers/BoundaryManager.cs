...
namespace MatchThemAll.Scripts.Runtime.Managers
{
    public class BoundaryManager : MonoBehaviour
    {
        ...
        private void SetBoundaryWallPosition()
        {
            ...
            SetupWall(topWall, topCenter, topWidth, wallThickness, wallHeight, groundY);
            ...
            SetupWall(bottomWall, bottomCenter, bottomWidth, wallThickness, wallHeight, groundY);
        ...
        private void SetupWall(GameObject wall, Vector3 position, float width, float depth, float height, float groundY)
        {
            if (wall == null) return;
